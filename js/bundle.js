...
function cards() {
  ...
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(image, alt, title, text, price, parentSelector) {
    ...
    _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        if (this.classes.length === 0) {
          ...
          this.classes.forEach(function (clasName) {
            return element.classList.add(clasName);
          });
        }
...
function forms(formSelector, modalTimeId) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.openModal)('.modal', modalTimeId);
...
function modal(triggerSelector, modalSelector, modalTimeId) {
  ...
  modalTrigger.forEach(function (item) {
    item.addEventListener('click', function () {
      return openModal(modalSelector, modalTimeId);
    });
  });
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimeId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalTimeId);
  }, 30000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('button[data-modal]', '.modal', modalTimeId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2022-04-15');
